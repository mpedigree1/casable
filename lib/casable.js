...
(function() {
  ...
  Casable = (function() {
    function Casable(ssoBaseURL, config, done) {
    ...
    Casable.prototype.authenticate = function(req, res, next) {
      ...
      if ((req.session != null) && (req.session.authenticatedUser != null)) {
        ...
        this.done(req, res, req.session.authenticatedUser);
        next();
        return;
      }
  ...
  exports.authentication = function(ssoBaseURL, config, done) {
    if (config == null) {
      config = {};
    }
